...
import ru.itmo.highload.catering.common.error.RequestTraceFilter;
...
public class CatalogService {
    ...
    public Map<UUID, ActiveDishData> getActiveDishPrices(Set<UUID> ids) {
        ...
        String traceId = RequestContextHolder.getRequestAttributes() instanceof ServletRequestAttributes attributes
                ? (String) attributes.getRequest().getAttribute(RequestTraceFilter.TRACE_ID_ATTRIBUTE) : null;
